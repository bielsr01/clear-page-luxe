...
-- Fix expense_date default to use Brasília timezone
ALTER TABLE public.expenses
  ALTER COLUMN expense_date SET DEFAULT ((now() AT TIME ZONE 'America/Sao_Paulo')::date);

-- Fix supply-order -> expense trigger to use Brasília timezone
