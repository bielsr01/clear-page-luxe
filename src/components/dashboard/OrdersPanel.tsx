...
export function OrdersPanel({ restaurantId }: { restaurantId: string }) {
  ...
  const renderCard = (o: Order, compact = false) => {
    ...
    return (
      <Card key={o.id} className="shadow-soft cursor-pointer hover:bg-accent/30 transition-colors h-auto md:h-[280px] flex flex-col overflow-hidden" onClick={() => setDetailsTarget(o)}>
    ...
    <div className="flex flex-col gap-4 h-[calc(100vh-7rem)] pb-4">
      <div className="flex flex-wrap items-center justify-between gap-3 shrink-0">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto flex-wrap">
          ...
          <Button variant="outline" size="sm" onClick={() => setFinalizedOpen(true)} className="gap-2 flex-1 md:flex-none text-xs md:text-sm ml-auto">
