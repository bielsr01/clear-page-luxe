  ...
  return (
    <>
      <style>{`
        ...
        .ticket { width: 72mm; margin: 0 auto; padding: 8px; font-family: 'Arial',sans-serif; color: #000; font-size: 15px; line-height: 1.45; font-weight: 700; -webkit-text-stroke: 0.3px #000; }
        ...
        .ticket .sep { border-top: 1.5px solid #000; margin: 6px 0; }
        .ticket .item-name { font-weight: 900; -webkit-text-stroke: 0.5px #000; }
        .ticket .total { font-size: 17px; font-weight: 900; -webkit-text-stroke: 0.6px #000; }
